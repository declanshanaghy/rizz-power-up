...
- **Primary Buttons**: Rounded with subtle texture, like hand-pressed paper
...
4. **List Items**: Begin with an emoji that captures the essence of each point
   ```
